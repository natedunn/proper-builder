  ...
  return (
    <>
      ...
      >
        ...
        >
          <div class='min-h-0'>
            ...
            <ol class='mt-6 flex items-center gap-4 rounded-2xl bg-zinc-900/50 p-4'>
      ...
      <div class='flex-auto border-t border-zinc-700/50 bg-zinc-900'>
        ...
        <div class='mb-6 inline-block w-full border-b border-zinc-800 pt-2' />
        <div class='container'>
            ...
            <Show when={!loadingSavedQueue()} fallback={<>Loading...</>}>
              ...
              >
                ...
                <div class='sticky bottom-4'>
                  <div class='flex items-center justify-between gap-3 rounded-xl border border-zinc-700/75 bg-zinc-900/75 px-5 py-4 backdrop-blur-lg'>
                    <div class='flex gap-3'>
                      <button class='button'>Download</button>
                      <button class='button'>Clear all</button>
                    </div>
                    <div>
                      <A class='link' href='/how'>
                        Got questions?
                      </A>
                    </div>
                  </div>
